...
public class AgodaJobDetailsTests {
	WebDriver driver;
	...
	public void agodaTest() {
		...
		System.out.println("Main page is open.");
		 ...
		 driver.findElement(By.xpath("//div[@id='experience']/div[2]/button[1]/b[.='Senior QA Engineer / Agoda.com']")).click();
		 
		 //verification that agoda job details is displayed
		 Assert.assertTrue(driver.findElement(By.id("agoda")).isDisplayed());
